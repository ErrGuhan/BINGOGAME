class SoundController {
  ...
  public playTap() {
    try {
      ...
      console.warn('Audio tap suppressed:', err);
    }
  }
  ...
  public playDraft(frequency = 520) {
    try {
      ...
      console.warn('Audio draft suppressed:', err);
    }
  }
  ...
  public playCall() {
    try {
      ...
      console.warn('Audio call suppressed:', err);
    }
  }
  ...
  public playMatch() {
    try {
      ...
      console.warn('Audio match suppressed:', err);
    }
  }
  ...
  public playLineComplete() {
    try {
      ...
      console.warn('Audio lineComplete suppressed:', err);
    }
  }
  ...
  public playVictory() {
    try {
      ...
      console.warn('Audio victory suppressed:', err);
    }
  }
  ...
  public playAlert() {
    try {
      ...
      console.warn('Audio alert suppressed:', err);
    }
  }
}
